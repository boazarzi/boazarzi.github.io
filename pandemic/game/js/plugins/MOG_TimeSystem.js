...
// * Create
//==============================
var _alias_mog_timesys_scmenu_create = Scene_MenuBase.prototype.create
...
// * create Time Status
//==============================
Scene_MenuBase.prototype.createTimeStatus = function() {
   $gameSystem._refresh_window_time = false;
...
Window_Time_Status.prototype.initialize = function(x, y) {
    ...
    Window_Base.prototype.initialize.call(this, 0, 0, 140 /*240*/, 228);
...
Window_Time_Status.prototype.draw_time_contents = function() {
   ...
   if (this._mode === 1) {
       ...
       var text = $gameSystem.month().padZero(2) + "/" + $gameSystem.day().padZero(2) + "/" + $gameSystem.year().padZero(2);
       this.contents.drawText(text, x - 30, y, 120,32,"right");
