...
Scene_CustomMenu.prototype.createGoldWindow = function() {
    this._goldWindow = new Window_Gold(0, 0);
    this._goldWindow.y = Graphics.boxHeight - this._goldWindow.height;
    this.addWindow(this._goldWindow);
};

Scene_CustomMenu.prototype.createStatusWindow = function() {
    this._statusWindow = new Window_MenuStatus(this._commandWindow.width, 0);
    this._statusWindow.reserveFaceImages();
    this.addWindow(this._statusWindow);
};

Scene_CustomMenu.prototype.commandItem = function() {
    SceneManager.push(Scene_Item);
};

Scene_CustomMenu.prototype.commandPersonal = function() {
...
Scene_CustomMenu.prototype.commandFormation = function() {
...
Scene_CustomMenu.prototype.commandOptions = function() {
    SceneManager.push(Scene_Options);
};

Scene_CustomMenu.prototype.commandSave = function() {
    SceneManager.push(Scene_Save);
};

Scene_CustomMenu.prototype.commandGameEnd = function() {
    SceneManager.push(Scene_GameEnd);
};

Scene_CustomMenu.prototype.onPersonalOk = function() {
...
Scene_CustomMenu.prototype.onPersonalCancel = function() {
    this._statusWindow.deselect();
    this._commandWindow.activate();
};

Scene_CustomMenu.prototype.onFormationOk = function() {
...
Scene_CustomMenu.prototype.onFormationCancel = function() {
